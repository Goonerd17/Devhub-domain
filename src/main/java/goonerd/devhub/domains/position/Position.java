package goonerd.devhub.domains.position;
...
public class Position {
    ...
    public static Position createPosition(String positionGuid, String projectGuid, String positionName, int capacity, String level, int approvedCount) {
        return new Position(positionGuid, projectGuid, positionName, capacity, level, approvedCount);
    }
